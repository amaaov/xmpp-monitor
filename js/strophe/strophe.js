...
Strophe = {
    ...
    getNodeFromJid: function (jid)
    {
    	...
    	var atPos = bare.indexOf("@");
        if (atPos < 0)
            return null;
        return bare.substring(0, atPos-1);
    },
    ...
    {
        var slashPos = jid.indexOf("/");
        if (slashPos < 0) return null;
        return jid.substr(slashPos+1);
    },
    ...
    getBareJidFromJid: function (jid)
    {
    	...
    	if(slashPos < 0)
    		return jid;
        return jid.substring(0, slashPos);
    },
